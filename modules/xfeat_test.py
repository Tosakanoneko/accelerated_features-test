...
from modules.model_shift import *
...
class XFeat(nn.Module):
    ...
    def __init__(self, weights = os.path.abspath(os.path.dirname(__file__)) + '/../weights/xfeat.pt', top_k = 4096, detection_threshold=0.05):
        ...
        self.net1 = XFeatModel().to(self.dev).eval()
        self.net2 = XFeatModel_shift().to(self.dev).eval()
        self.top_k = top_k
    ...
    def detectAndCompute1(self, x, top_k = None, detection_threshold = None):
        """
    ...
    @torch.inference_mode()
    def detectAndComputeDense(self, x, top_k = None, multiscale = False):
        """
    ...
    def NMS(self, x, threshold = 0.05, kernel_size = 5):
        ...
        print("NMS time:{:.6f}".format(time.time()-start_time))
        return pos
